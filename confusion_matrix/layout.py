...
layout = html.Div(
                        ...
                        html.Div(
                            ...
                            Classification tasks are among the most common problems in data science. Take a look at the following examples and I am sure you will find yourself in one, if not all of them:"""
                                                ...
                                                html.Ul(
                                                    [
                                                        html.Li(
                                                            "Netflix recommends a movie you actually like"
                                                        ),
                                                        html.Li(
                                                            "Spotify suggests a song that turns out to become one of your favorites"
                                                        ),
                                                        html.Li(
                                                            "Amazon advertises a book that fits your favorite genre"
                                                        ),
                                                        html.Li(
                                                            "Instagram promotes a channel based on your interests"
                                                        ),
                                                        html.Li(
                                                            "Your bank rejects your mortgage application"
                                                        ),
                                                        html.Li(
                                                            "Receiving an email from the son of the Nigerian prince who, for whatever reason, wants to share his fortune with you"
                                                        ),
                                                    ]
                                                ),
                                                html.P(
                                ...
                                """
                                                ...
                                                html.Ol(
                                                    [
                                                        html.Li(
                                                            dcc.Markdown(
                                                                "True Negatives (TN): Observations that **do not belong** to the target label and were classified as **not belonging** to the target label. In our case: handwritten digits of 0, 3 and 9 that were **not classified** as 5s."
                                                            )
                                                        ),
                                                        html.Li(
                                                            dcc.Markdown(
                                                                "False Positives (FP): Observations that **do not belong** to the target label and were classified as **belonging** to the target label. In our case: handwritten digits of 0, 3 and 9 that were **classified** as 5s."
                                                            )
                                                        ),
                                                        html.Li(
                                                            dcc.Markdown(
                                                                "False Negatives (FN): Observations that **belong** to the target label and were classified as **not belonging** to the target label. In our case: handwritten digits of 5s that were **not classified** as 5s."
                                                            )
                                                        ),
                                                        html.Li(
                                                            dcc.Markdown(
                                                                "True Positives (TP): Observations that **belong** to the target label and were classified as **belonging** to the target label. In our case: handwritten digits of 5s that were **classified** as 5s."
                                                            )
                                                        ),
                                                    ]
                                                ),
                                ...
                                """
                                                            ...
                                                            dbc.Card(
                                                                dbc.CardBody(
                                                                    [
                                                                        ...
                                                                        html.P(
                                                                            "$$ = \\frac{\\textrm{TN}+\\textrm{TP}}{\\textrm{TN}+\\textrm{FP}+\\textrm{FN}+\\textrm{TP}} $$"
                                                                        ),
                                                                    ]
                                                                )
                                                            ),
                                                            ...
                                                            dbc.Card(
                                                                dbc.CardBody(
                                                                    [
                                                                        ...
                                                                        html.P(
                                                                            "$$ = 2*\\frac{\\textrm{recall}*\\textrm{precision}}{\\textrm{recall}+\\textrm{precision}} $$"
                                                                        ),
                                                                    ]
                                                                )
                                                            ),
                                                ...
                                                html.Ol(
                                                    [
                                                        html.Li(
                                                            dcc.Markdown(
                                                                "Accuracy: ratio of all correct predictions (TN, TP) to all predictions (TN, FP, FN, TP)."
                                                            )
                                                        ),
                                                        html.Li(
                                                            dcc.Markdown(
                                                                "Precision: ratio of correctly classified positive labels (TP) to all positive classifications (TP, FP)."
                                                            )
                                                        ),
                                                        html.Li(
                                                            dcc.Markdown(
                                                                "Recall: ratio of correctly classified positive labels (TP) to all actual positive labels (TP, FN)."
                                                            )
                                                        ),
                                                        html.Li(
                                                            dcc.Markdown(
                                    ...
                                    [
                                        dbc.Col(
                                            dbc.Card(
                                                ...
                                                style={
                                                    "height": "105px",
                                                    "background-color": "#343a40ed !important",
                                                },
                                            )
                                        ),
                                    ],
                                    className="sticky col-lg-4 col-md-6 col-sm-6",
                                    style={
                                        "margin-left": "auto",
                                        "margin-right": "auto",
                                        "height": "105px",
    ...
    className="container",
    style={"padding-bottom": "150px", "max-width": "100%"},
)
